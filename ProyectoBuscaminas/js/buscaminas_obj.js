...
class Buscaminas extends Tablero {
    ...
    ganar()
    {
        ...
        for (let i = 0; i < this.filas; i++) {
            for (let j = 0; j < this.columnas; j++){
                ...
                celda = document.getElementById(`f${i}_c${j}`);
                despejado = console.log(celda.getAttribute("data-despejado"));
                if(despejado == true)
                {
                    contadorDeCasillas++
                }
        ...
        if(contadorDeCasillas >= ((this.filas * this.columnas) - this. numMinas))
        {
            alert("Has ganado");
        }
    }
    ...
    despejarCelda(celda) {
        ...
        let rutaBandera = "js/imgs/bandera.png";
    ...
    marcar(elEvento) {
        ...
        let rutaBandera = 'imgs/bandera.png';
        let rutaInterrogante = 'imgs/interrogante.png';
        ...
        if (noHayImagen) {
            celda.removeEventListener('click', this.despejar);
            imagen.src = "imgs/bandera.png";
            celda.appendChild(imagen);
        } else if (esBandera) {
            celda.addEventListener('click', this.despejar);
            celda.lastChild.src = "imgs/interrogante.png";
